...
var POSTPROCESSING = (() => {
  ...
  var CircleOfConfusionMaterial = class extends import_three3.ShaderMaterial {
    ...
    setDepthBuffer(buffer, depthPacking = import_three3.BasicDepthPacking) {
  ...
  // src/materials/KawaseBlurMaterial.js
  var KawaseBlurMaterial = class extends import_three4.ShaderMaterial {
    constructor(texelSize = new import_three4.Vector2()) {
      super({
        ...
        uniforms: {
          ...
          halfTexelSize: new import_three4.Uniform(new import_three4.Vector2()),
          kernel: new import_three4.Uniform(0),
  ...
  // src/materials/CopyMaterial.js
  var CopyMaterial = class extends import_three5.ShaderMaterial {
    constructor() {
      super({
        name: "CopyMaterial",
        uniforms: {
          inputBuffer: new import_three5.Uniform(null),
          opacity: new import_three5.Uniform(1)
        },
  ...
  // src/materials/DepthComparisonMaterial.js
  var DepthComparisonMaterial = class extends import_three6.ShaderMaterial {
    constructor(depthTexture = null, camera) {
      super({
        name: "DepthComparisonMaterial",
        uniforms: {
          depthBuffer: new import_three6.Uniform(null),
          cameraNear: new import_three6.Uniform(0.3),
          cameraFar: new import_three6.Uniform(1e3)
        },
    ...
    setDepthBuffer(buffer, depthPacking = import_three6.BasicDepthPacking) {
      this.uniforms.depthBuffer.value = buffer;
      this.defines.DEPTH_PACKING = depthPacking.toFixed(0);
      this.needsUpdate = true;
    }
    adoptCameraSettings(camera) {
      if (camera) {
        this.uniforms.cameraNear.value = camera.near;
        this.uniforms.cameraFar.value = camera.far;
        if (camera instanceof import_three6.PerspectiveCamera) {
          this.defines.PERSPECTIVE_CAMERA = "1";
        } else {
          delete this.defines.PERSPECTIVE_CAMERA;
        }
  ...
  var DepthCopyMaterial = class extends import_three7.ShaderMaterial {
    constructor() {
      super({
        ...
        uniforms: {
          ...
          texelPosition: new import_three7.Uniform(new import_three7.Vector2())
        },
    ...
    setDepthBuffer(buffer, depthPacking = import_three7.BasicDepthPacking) {
      this.uniforms.depthBuffer.value = buffer;
  ...
  var DepthMaskMaterial = class extends import_three9.ShaderMaterial {
    ...
    setDepthBuffer0(buffer, depthPacking = import_three9.BasicDepthPacking) {
      this.uniforms.depthBuffer0.value = buffer;
      this.defines.DEPTH_PACKING_0 = depthPacking.toFixed(0);
      this.needsUpdate = true;
    }
    setDepthBuffer1(buffer, depthPacking = import_three9.BasicDepthPacking) {
  ...
  var EffectMaterial = class extends import_three11.ShaderMaterial {
    constructor(shaderParts, defines, uniforms, camera, dithering = false) {
      super({
        name: "EffectMaterial",
        defines: {
          THREE_REVISION: import_three11.REVISION.replace(/\D+/g, ""),
          DEPTH_PACKING: "0",
          ENCODE_OUTPUT: "1"
        },
        uniforms: {
  ...
  var MaskMaterial = class extends import_three14.ShaderMaterial {
    ...
    setMaskTexture(value) {
      ...
      if (value.type !== import_three14.UnsignedByteType) {
  ...
  var SSAOMaterial = class extends import_three17.ShaderMaterial {
    constructor(camera) {
      super({
        ...
        uniforms: {
          depthBuffer: new import_three17.Uniform(null),
    ...
    setDepthBuffer(buffer, depthPacking = import_three17.BasicDepthPacking) {
      this.uniforms.depthBuffer.value = buffer;
      this.defines.DEPTH_PACKING = depthPacking.toFixed(0);
      this.needsUpdate = true;
    }
  ...
  var Pass = class {
    ...
    setFullscreenMaterial(value) {
      ...
      if (screen !== null) {
        ...
        screen = new import_three18.Mesh(getFullscreenTriangle(), value);
  ...
  var color = new import_three21.Color();
  ...
  var AUTO_SIZE = -1;
  var Resolution = class extends import_three22.EventDispatcher {
    constructor(resizable, width = AUTO_SIZE, height = AUTO_SIZE, scale = 1) {
      super();
      this.resizable = resizable;
      this.base = new import_three22.Vector2(1, 1);
      this.preferred = new import_three22.Vector2(width, height);
        ...
        if (node.isMesh) {
          ...
          if (node.material.flatShading) {
            switch (node.material.side) {
              case import_three23.DoubleSide:
                materials = this.materialsFlatShadedDoubleSide;
                break;
              case import_three23.BackSide:
    ...
    setMaterial(material) {
      ...
      if (material !== null) {
        ...
        for (const m2 of materials) {
          ...
          m2.side = import_three23.FrontSide;
        }
        materials[2].skinning = true;
        this.materialsBackSide = materials.map((m2) => {
          const c2 = m2.clone();
          c2.uniforms = Object.assign({}, material.uniforms);
          c2.side = import_three23.BackSide;
          return c2;
        });
        this.materialsDoubleSide = materials.map((m2) => {
          const c2 = m2.clone();
          c2.uniforms = Object.assign({}, material.uniforms);
          c2.side = import_three23.DoubleSide;
          return c2;
        });
  ...
  var DepthPass = class extends Pass {
    constructor(scene, camera, {
      ...
      clearPass.setOverrideClearColor(new import_three24.Color(16777215));
  ...
  var DepthDownsamplingPass = class extends Pass {
    ...
    setDepthTexture(depthTexture, depthPacking = import_three25.BasicDepthPacking) {
  ...
  var DepthCopyPass = class extends Pass {
    constructor({ depthPacking = import_three26.RGBADepthPacking } = {}) {
      super("DepthCopyPass");
      ...
      this.renderTarget = new import_three26.WebGLRenderTarget(1, 1, {
        type: depthPacking === import_three26.RGBADepthPacking ? import_three26.UnsignedByteType : import_three26.FloatType,
  ...
  var DepthPickingPass = class extends DepthCopyPass {
    constructor({ depthPacking = import_three27.RGBADepthPacking, mode = DepthCopyMode.SINGLE } = {}) {
      super({ depthPacking });
      this.name = "DepthPickingPass";
      this.getFullscreenMaterial().setMode(mode);
      this.pixelBuffer = depthPacking === import_three27.RGBADepthPacking ? new Uint8Array(4) : new Float32Array(4);
      this.callback = null;
    }
    readDepth(ndc) {
    ...
    render(renderer, inputBuffer, outputBuffer, deltaTime, stencilTest) {
      ...
      if (this.callback !== null) {
        ...
        const packed = renderTarget.texture.type !== import_three27.FloatType;
        let x = 0, y = 0;
  ...
  var BlendMode = class extends import_three28.EventDispatcher {
    constructor(blendFunction, opacity = 1) {
      super();
      this.blendFunction = blendFunction;
      this.opacity = new import_three28.Uniform(opacity);
    }
    getOpacity() {
  ...
  var Effect = class extends import_three29.EventDispatcher {
    ...
    dispose() {
      for (const key of Object.keys(this)) {
        const property = this[key];
        if (property !== null && typeof property.dispose === "function") {
          if (property instanceof import_three29.Scene) {
            continue;
          }
          this[key].dispose();
        }
  ...
  var NormalPass = class extends Pass {
    constructor(scene, camera, {
      ...
      super("NormalPass");
      this.needsSwap = false;
      this.renderPass = new RenderPass(scene, camera, new import_three33.MeshNormalMaterial());
      const renderPass = this.renderPass;
      renderPass.setBackgroundDisabled(true);
      renderPass.setShadowMapDisabled(true);
      const clearPass = renderPass.getClearPass();
      clearPass.setOverrideClearColor(new import_three33.Color(7829503));
      clearPass.setOverrideClearAlpha(1);
      this.renderTarget = renderTarget;
      if (this.renderTarget === void 0) {
  ...
  var EffectComposer = class {
    ...
    createBuffer(depthBuffer, stencilBuffer, type, multisampling) {
      const size = this.renderer === null ? new import_three35.Vector2() : this.renderer.getDrawingBufferSize(new import_three35.Vector2());
      const options = {
      ...
      let renderTarget;
      if (multisampling > 0) {
        renderTarget = Number(import_three35.REVISION.replace(/\D+/g, "")) < 138 ? new import_three35.WebGLMultisampleRenderTarget(size.width, size.height, options) : new import_three35.WebGLRenderTarget(size.width, size.height, options);
        renderTarget.ignoreDepthForMultisampleCopy = false;
        renderTarget.samples = multisampling;
      } else {
        renderTarget = new import_three35.WebGLRenderTarget(size.width, size.height, options);
      }
  ...
  var GlitchEffect = class extends Effect {
    constructor({
      ...
      super("GlitchEffect", shader_default55, {
        ...
        uniforms: /* @__PURE__ */ new Map([
          ...
          ["seeds", new import_three45.Uniform(new import_three45.Vector2())],
    ...
    setPerturbationMap(value) {
      ...
      value.minFilter = value.magFilter = import_three45.NearestFilter;
    ...
    generatePerturbationMap(value = 64) {
      const map = new NoiseTexture(value, value, import_three45.RGBAFormat);
      map.name = textureTag;
      return map;
    }
    update(renderer, inputBuffer, deltaTime) {
  ...
  var GodRaysEffect = class extends Effect {
    constructor(camera, lightSource, {
      ...
      this.renderPassLight.getClearPass().setOverrideClearColor(new import_three46.Color(0));
      this.clearPass = new ClearPass(true, false, false);
      this.clearPass.setOverrideClearColor(new import_three46.Color(0));
      this.blurPass = new KawaseBlurPass({ resolutionScale, width, height, kernelSize });
  ...
  var LookupTexture3D = class extends import_three49.DataTexture3D {
    ...
    applyLUT(lut) {
      ...
      } else if (lut.format !== import_three49.RGBAFormat || this.format !== import_three49.RGBAFormat) {
  ...
  var LUTEffect = class extends Effect {
    constructor(lut, { blendFunction = BlendFunction.NORMAL, tetrahedralInterpolation = false } = {}) {
      ...
      this.outputEncoding = import_three50.sRGBEncoding;
  ...
  function getTextureDecoding(texture, isWebGL2) {
    let decoding = "texel";
    if (texture !== null) {
      const revision = Number.parseInt(import_three51.REVISION);
      const sRGB8Alpha8 = isWebGL2 && revision >= 133 && revision !== 135 && texture.format === import_three51.RGBAFormat && texture.type === import_three51.UnsignedByteType && texture.encoding === import_three51.sRGBEncoding;
      if (!sRGB8Alpha8) {
  ...
  var OutlineEffect = class extends Effect {
    constructor(scene, camera, {
      ...
      this.clearPass = new ClearPass();
      this.clearPass.setOverrideClearColor(new import_three52.Color(0));
      ...
      clearPass.setOverrideClearColor(new import_three52.Color(16777215));
      clearPass.setOverrideClearAlpha(1);
      this.blurPass = new KawaseBlurPass({ resolutionScale, width, height, kernelSize });
      this.blurPass.setEnabled(blur);
      const resolution = this.blurPass.getResolution();
  ...
  var ShockWaveEffect = class extends Effect {
    constructor(camera, position = new import_three56.Vector3(), {
      speed = 2,
      maxRadius = 1,
      waveSize = 0.2,
      amplitude = 0.05
  ...
  var SelectiveBloomEffect = class extends BloomEffect {
    constructor(scene, camera, options) {
      ...
      this.depthPass = new DepthPass(scene, camera);
      this.clearPass = new ClearPass(true, false, false);
      this.clearPass.setOverrideClearColor(new import_three57.Color(0));
      this.depthMaskPass = new ShaderPass(new DepthMaskMaterial());
      const depthMaskMaterial = this.depthMaskPass.getFullscreenMaterial();
      depthMaskMaterial.setDepthBuffer1(this.depthPass.getTexture(), import_three57.RGBADepthPacking);
    ...
    isInverted() {
      return this.getDepthMaskMaterial().getDepthMode() === import_three57.NotEqualDepth;
    }
    setInverted(value) {
      this.getDepthMaskMaterial().setDepthMode(value ? import_three57.NotEqualDepth : import_three57.EqualDepth);
    }
  ...
  var SMAAEffect = class extends Effect {
    constructor(searchImage, areaImage, preset = SMAAPreset.HIGH, edgeDetectionMode = EdgeDetectionMode.COLOR) {
      ...
      this.clearPass = new ClearPass(true, false, false);
      this.clearPass.setOverrideClearColor(new import_three59.Color(0));
      this.clearPass.setOverrideClearAlpha(1);
  ...
  var SSAOEffect = class extends Effect {
    constructor(camera, normalBuffer, {
      ...
      const noiseTexture = new NoiseTexture(NOISE_TEXTURE_SIZE, NOISE_TEXTURE_SIZE, import_three60.RGBAFormat);
  ...
  var VignetteEffect = class extends Effect {
    constructor({
      ...
      super("VignetteEffect", shader_default75, {
        ...
        uniforms: /* @__PURE__ */ new Map([
          ["offset", new import_three63.Uniform(offset)],
          ["darkness", new import_three63.Uniform(darkness)]
        ])
      });
    }
    get eskil() {
